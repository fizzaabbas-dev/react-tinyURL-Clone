...
function App() {
  ...
  const handleFormSubmit = (e) => {
    ...
    const newLink = {
      ...
      short: `https://${domain}/${alias || Math.random().toString(36).substring(2, 8)}`,
  ...
  return (
    <div className="min-h-screen bg-[#002342] text-white font-sans flex flex-col justify-between selection:bg-[#0092b3] selection:text-white relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-8 items-start">
            ...
            <div className="flex flex-row lg:flex-col items-start text-left gap-5 lg:gap-4 group w-full">
              <div className="order-2 lg:order-1 flex-1 lg:w-full space-y-2.5">
                ...
                <p className="text-sm sm:text-[17px] text-[#4a5568] leading-[1.5] font-normal">
              ...
              <div className="order-1 lg:order-2 w-[120px] sm:w-32 lg:w-[200px] shrink-0">
                <img
      ...
      <section className="bg-[#0e7490] text-white w-full lg:pl-12 pr-0 py-0 overflow-hidden">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 items-stretch min-h-[auto] lg:h-[500px]">
          <div className="order-1 w-full h-[280px] sm:h-[340px] lg:h-full relative bg-black overflow-hidden">
            <video
              autoPlay
              loop
              muted
          ...
          <div className="order-2 flex flex-col justify-between px-6 sm:px-10 lg:px-16 py-10 lg:py-14 space-y-6 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
              <button className="w-full sm:w-auto bg-white text-[#002342] font-semibold px-8 py-3.5 rounded-[4px] text-center text-base">
                View Plans
              </button>
              <button
                type="button"
                className="w-full sm:w-auto bg-[#002342] text-white font-semibold px-8 py-3.5 rounded-[4px] text-center text-base"
              >
                Contact Sales
              </button>
            </div>
      ...
      <section className="bg-white pt-24 pb-12 px-4 sm:px-8 lg:px-12">
        <div className="max-w-[1450px] mx-auto text-center">
          <div className="mb-14">
            ...
            <div>
              <button className="bg-[#0e7490] hover:bg-[#0b5c74] text-white font-semibold px-8 py-3 rounded-[4px] transition-colors">
                View Plans
              </button>
            </div>
          </div>
          ...
          <div className="hidden lg:grid grid-cols-12 gap-4 items-center pt-2 pb-2">
            ...
            <div className="col-span-6 flex justify-center items-center pt-10">
              <div className="w-full max-w-[680px] h-[520px] flex items-center justify-center transition-all duration-500">
                <img
                  src={
                    [
          ...
          <div className="lg:hidden flex flex-col items-center px-4">
            <div className="w-full max-w-[400px] h-80 flex items-center justify-center mb-6">
              <img
                src={
                  [
                    "https://tinyurl.com/images/overhauling/card-feature-0.webp",
            ...
            <div className="w-full max-w-[400px] bg-[#f0f9ff] border border-[#bae6fd] p-6 rounded-xl text-left mb-6 mx-auto shadow-sm">
      ...
      <section className="bg-[#0b1d3a] text-white py-0 overflow-hidden">
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-6 flex justify-end items-center order-1 lg:order-2 w-full h-full">
            <div className="w-full h-full flex items-center justify-end">
              <video
                ...
                muted
                playsInline
                className="w-full h-auto lg:max-h-[420px] object-cover rounded-none shadow-none"
              >
                <source
      ...
      <section className="bg-white text-gray-900 py-10 px-6 sm:px-10 lg:px-12 w-full">
        <div className="max-w-[1250px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          {/* Heading Column */}
          <div className="lg:col-span-4 text-center lg:text-left">
            <h2 className="text-2xl sm:text-3xl lg:text-[34px] font-medium tracking-tight leading-[1.2] text-gray-900 max-w-[260px] mx-auto lg:mx-0">
